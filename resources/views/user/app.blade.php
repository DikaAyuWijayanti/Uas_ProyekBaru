...
<html lang="en">
  <head>
    <title>Welcome Pasar Sayur &mdash;Selamat Datang di Pasar Sayur Blitar</title>
    <meta charset="utf-8">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                ...
                <i class="icon-heart" aria-hidden="true"></i> <target="_blank" class="text-primary"><strong>Happy Shopping DEAR...</strong>
              </div>
            </div>
      ...
      <div class="container">
          ...
          <div class="col-md-6 col-lg-6">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Jl. Merpati No.1A</li>
                <li class="phone">+62878253546711</li>
                <li class="email">pasarSayur@gmail.com</li>
              </ul>
            </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> Pasar Sayur Blitar |  <i class="icon-heart" aria-hidden="true"></i> by <target="_blank" class="text-primary">DiNaFa
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
